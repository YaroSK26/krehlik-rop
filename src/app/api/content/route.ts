...
const DEFAULT_CONTENT = {
  ...
  subtitle:
    "Moderné riešenie pre vzdialené monitorovanie pomocou Raspberry Pi 5. Zabezpečený prístup k živému prenosu.",
  ...
  securityText:
    "Dáta sú prenášané cez lokálny stream v uzavretej sieti bez rizika externých útokov.",
};
